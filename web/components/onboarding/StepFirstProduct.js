  ...
  return (
    <div>
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold mb-2">{t("onboarding.chooseFirstProduct")}</h2>
        <p className="text-base-content/60">
          {t("onboarding.chooseFirstProductDesc")}
        </p>
      </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs text-base-content/50">{t("onboarding.safeScoreLabel")}</div>
                </div>
                {selected === product.id && (
