...
const list = [
  ...
  {
    name: "Yazdun",
    text: "I got the boilerplate, it's fantastic, you just save me 10 hours on each project",
    type: refTypes.other,
  },
  {
    username: "zawwadx",
  ...
  // The last testimonial is featured on big devices (span 2 columns + big font) 👇
  {
    username: "VicPivots",
    name: "Victor Abeledo",
    text: "I got this boilerplate and having the payments setup with Stripe + user auth is a blessing. This will save me like a week of work for each new side project I spin up. I appreciate that it is well documented, as well. 100% worth it!",
    type: refTypes.twitter,
