...
export default {
  ...
  seo: {
    // Homepage
    homeTitle: "SafeScoring - تقييمات أمان العملات المشفرة ومقارنة المحافظ",
    homeDescription: "أول تقييم أمان موحد لجميع منتجات الكريبتو. قارن محافظ الأجهزة، محافظ البرامج، منصات التداول وبروتوكولات DeFi. 1100 معيار. 500+ منتج مُقيّم.",
    
    // Products page
    productsTitle: "قاعدة بيانات أمان منتجات الكريبتو | SafeScoring",
    productsDescription: "استعرض درجات الأمان لأكثر من 500 منتج كريبتو. كل منتج مُقيّم وفق 1100 معيار أمان. قارن المحافظ، المنصات، بروتوكولات DeFi.",
    
    // Compare page
    compareTitle: "قارن منتجات الكريبتو - أداة مقارنة الأمان | SafeScoring",
    compareDescription: "مقارنة جنباً إلى جنب لأمان محافظ الكريبتو، المنصات وبروتوكولات DeFi. اعثر على المنتجات الأكثر أماناً.",
    
    // Methodology page
    methodologyTitle: "منهجية SAFE - كيف نُقيّم أمان الكريبتو | SafeScoring",
    methodologyDescription: "اكتشف كيف يُقيّم SafeScoring منتجات الكريبتو عبر 4 ركائز: الأمان، المواجهة، الموثوقية، الكفاءة. 1100 معيار. منهجية شفافة.",
    
    // Best pages
    bestHardwareWallets: "أفضل محافظ الأجهزة {year} - تصنيف الأمان | SafeScoring",
    bestSoftwareWallets: "أفضل محافظ البرامج {year} - تصنيف الأمان | SafeScoring",
    bestExchanges: "أفضل منصات الكريبتو {year} - تصنيف الأمان | SafeScoring",
    bestDefi: "أفضل بروتوكولات DeFi {year} - تصنيف الأمان | SafeScoring",
  },
  ...
  // Hero
  hero: {
    tagline: "{totalNorms} معيار. {totalProducts}+ منتج مُقيّم.",
    title: "مجموعة الكريبتو الخاصة بك لديها",
    titleHighlight: "نقطة عمياء أمنية",
    subtitle: "محافظ الأجهزة. محافظ البرامج. بروتوكولات DeFi.",
    subtitleStrong: "الكل مُقيّم بنفس المنهجية المنشورة.",
    ctaPrimary: "حلل مجموعتك",
    ctaSecondary: "استكشف المنتجات",
    trustIndicator: "مجاني · دقيقتان · بدون تسجيل",
    statsNorms: "المعايير",
  ...
  productDetail: {
    ...
    descriptionFallback: "{product} هو {type} تم تقييمه بواسطة SafeScoring.",
  },

  about: {
    meta: {
      title: "حول {app} - مهمتنا",
      description: "تعرّف على مهمة SafeScoring في جلب الشفافية والموضوعية لتقييمات أمان التشفير.",
    },
    hero: {
      badge: "مهمتنا",
      titleStart: "نجعل أمان التشفير",
      titleHighlight: "قابلاً للقياس",
      subtitle: "يجب أن يكون الأمان موضوعيًا وشفافًا ومتاحًا للجميع. ليس تسويقًا ولا رعاية مدفوعة، بل بيانات فقط.",
    },
    problem: {
      title: "المشكلة التي رأيناها",
      body1: "تشير التقارير إلى أن معظم مشاريع DeFi المخترقة كانت قد خضعت للتدقيق. ضاعت مليارات رغم \"شهادات الأمان\".",
      body2: "احتاج القطاع إلى تصنيف موحّد يتجاوز تدقيق الكود لقياس الأمان الواقعي.",
      body3: "وُلد SafeScoring من هذا الاحتياج.",
      stats: {
        norms: "معايير الأمان",
        pillars: "أعمدة SAFE",
        types: "أنواع المنتجات",
        framework: "إطار موحّد",
      },
    },
    values: {
      title: "قيمنا",
      subtitle: "المبادئ التي توجه كل تقييم ننشره",
      independence: {
        title: "الاستقلالية",
        desc: "علاقات الشراكة يتم الإفصاح عنها ولا تؤثر على الدرجات.",
      },
      transparency: {
        title: "الشفافية",
        desc: "منهجية مفتوحة. كل معيار وكل بند معلن.",
      },
      rigor: {
        title: "الصرامة",
        desc: "{totalNorms} معيارًا عبر 4 أعمدة. بناءً على منهجيتنا المنشورة.",
      },
      accessibility: {
        title: "الإتاحة",
        desc: "معرفة الأمان للجميع، وليس للخبراء التقنيين فقط.",
      },
    },
    cta: {
      title: "جاهز لرؤية الفارق؟",
      body: "استكشف تقييمات منتجاتنا أو تعرّف أكثر على منهجيتنا.",
      primary: "استكشاف المنتجات",
      secondary: "تعلّم المنهجية",
    },
  },
  audit: {
    hero: {
