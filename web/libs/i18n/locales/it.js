...
export default {
  ...
  seo: {
    // Homepage
    homeTitle: "SafeScoring - Valutazioni Sicurezza Crypto & Confronto Wallet",
    homeDescription: "La prima valutazione di sicurezza unificata per tutti i prodotti crypto. Confronta hardware wallet, software wallet, exchange e protocolli DeFi. {totalNorms} norme. {totalProducts}+ prodotti valutati.",
    
    // Products page
    productsTitle: "Database Sicurezza Prodotti Crypto | SafeScoring",
    productsDescription: "Consulta i punteggi di sicurezza di {totalProducts}+ prodotti crypto. Ogni prodotto valutato secondo {totalNorms} norme di sicurezza. Confronta wallet, exchange, protocolli DeFi.",
    
    // Compare page
    compareTitle: "Confronta Prodotti Crypto - Strumento di Confronto Sicurezza | SafeScoring",
    compareDescription: "Confronto fianco a fianco della sicurezza di wallet crypto, exchange e protocolli DeFi. Trova i prodotti più sicuri.",
    
    // Methodology page
    methodologyTitle: "Metodologia SAFE - Come Valutiamo la Sicurezza Crypto | SafeScoring",
    methodologyDescription: "Scopri come SafeScoring valuta i prodotti crypto su 4 pilastri: Sicurezza, Avversità, Fedeltà, Efficienza. {totalNorms} norme. Metodologia trasparente.",
    
    // Best pages
    bestHardwareWallets: "Migliori Hardware Wallet {year} - Classifica Sicurezza | SafeScoring",
    bestSoftwareWallets: "Migliori Software Wallet {year} - Classifica Sicurezza | SafeScoring",
    bestExchanges: "Migliori Exchange Crypto {year} - Classifica Sicurezza | SafeScoring",
    bestDefi: "Migliori Protocolli DeFi {year} - Classifica Sicurezza | SafeScoring",
  },

  // Common (fallback to English for missing keys)
  common: {
    back: "Indietro",
    save: "Salva",
    cancel: "Annulla",
  ...
  // Hero
  hero: {
    tagline: "{totalNorms} norme. {totalProducts}+ prodotti valutati.",
  ...
  productDetail: {
    ...
    descriptionFallback: "{product} è un {type} valutato da SafeScoring.",
  },

  about: {
    meta: {
      title: "Informazioni su {app} - La nostra missione",
      description: "Scopri la missione di SafeScoring: portare trasparenza e oggettività nelle valutazioni di sicurezza crypto.",
    },
    hero: {
      badge: "La nostra missione",
      titleStart: "Rendere la sicurezza crypto",
      titleHighlight: "misurabile",
      subtitle: "La sicurezza deve essere oggettiva, trasparente e accessibile. Niente marketing. Niente sponsorizzazioni. Solo dati.",
    },
    problem: {
      title: "Il problema che abbiamo visto",
      body1: "Molti progetti DeFi violati erano già stati auditati. Miliardi persi nonostante le «certificazioni di sicurezza».",
      body2: "Serviva qualcosa di diverso: un rating unificato che vada oltre gli audit di codice e misuri la sicurezza reale.",
      body3: "SafeScoring nasce da questa esigenza.",
      stats: {
        norms: "norme di sicurezza",
        pillars: "pilastri SAFE",
        types: "tipi di prodotto",
        framework: "framework unificato",
      },
    },
    values: {
      ...
      transparency: {
        title: "Trasparenza",
        desc: "Metodologia aperta. Ogni norma e criterio è pubblico.",
      },
      rigor: {
        title: "Rigore",
      ...
      accessibility: {
        title: "Accessibilità",
        desc: "Conoscenza della sicurezza per tutti, non solo per gli esperti tecnici.",
      },
    },
    cta: {
      title: "Pronto a vedere la differenza?",
      body: "Esplora i punteggi dei prodotti o scopri la nostra metodologia.",
      primary: "Esplora i prodotti",
      secondary: "Scopri la metodologia",
    },
  },
  audit: {
    hero: {
