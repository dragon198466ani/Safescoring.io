...
export default {
  ...
  seo: {
    // Homepage
    homeTitle: "SafeScoring - Рейтинги Безопасности Криптовалют & Сравнение Кошельков",
    homeDescription: "Первый единый рейтинг безопасности для всех криптопродуктов. Сравните аппаратные кошельки, программные кошельки, биржи и DeFi протоколы. 1100 норм. 500+ продуктов оценено.",
    
    // Products page
    productsTitle: "База Данных Безопасности Криптопродуктов | SafeScoring",
    productsDescription: "Просмотрите оценки безопасности 500+ криптопродуктов. Каждый продукт оценен по 1100 нормам безопасности. Сравните кошельки, биржи, DeFi протоколы.",
    
    // Compare page
    compareTitle: "Сравнить Криптопродукты - Инструмент Сравнения Безопасности | SafeScoring",
    compareDescription: "Сравнение безопасности криптокошельков, бирж и DeFi протоколов бок о бок. Найдите самые безопасные продукты.",
    
    // Methodology page
    methodologyTitle: "Методология SAFE - Как Мы Оцениваем Безопасность Криптовалют | SafeScoring",
    methodologyDescription: "Узнайте, как SafeScoring оценивает криптопродукты по 4 столпам: Безопасность, Устойчивость, Надежность, Эффективность. 1100 норм. Прозрачная методология.",
    
    // Best pages
    bestHardwareWallets: "Лучшие Аппаратные Кошельки {year} - Рейтинг Безопасности | SafeScoring",
    bestSoftwareWallets: "Лучшие Программные Кошельки {year} - Рейтинг Безопасности | SafeScoring",
    bestExchanges: "Лучшие Криптобиржи {year} - Рейтинг Безопасности | SafeScoring",
    bestDefi: "Лучшие DeFi Протоколы {year} - Рейтинг Безопасности | SafeScoring",
  },
  ...
  // Hero
  hero: {
    tagline: "{totalNorms} норм. {totalProducts}+ продуктов оценено.",
    title: "В вашем крипто-стеке есть",
    titleHighlight: "слепая зона безопасности",
    subtitle: "Аппаратные кошельки. Программные кошельки. DeFi протоколы.",
    subtitleStrong: "Все оценены по единой опубликованной методологии.",
    ctaPrimary: "Анализировать Ваш Стек",
    ctaSecondary: "Исследовать Продукты",
    trustIndicator: "Бесплатно · 2 мин · Без регистрации",
    statsNorms: "Нормы",
  ...
  productDetail: {
    ...
    typeSeparator: "•",
    typeUnknown: "ÐÐµÐ¸Ð·Ð²ÐµÑÑ‚Ð½Ð¾",
    descriptionFallback: "{product} — {type}, Ð¾Ñ†ÐµÐ½ÐµÐ½Ð½Ñ‹Ð¹ SafeScoring.",
  },
  about: {
    meta: {
      title: "О {app} - Наша миссия",
      description: "Узнайте, как SafeScoring приносит прозрачность и объективность в рейтинги безопасности крипто.",
    },
    hero: {
      badge: "Наша миссия",
      titleStart: "Делаем безопасность крипто",
      titleHighlight: "измеримой",
      subtitle: "Безопасность должна быть объективной, прозрачной и доступной. Без маркетинга, без спонсоров — только данные.",
    },
    problem: {
      title: "Проблема, которую мы увидели",
      body1: "По отчетам, большинство взломанных DeFi-проектов уже были аудированы. Миллиарды потеряны несмотря на «сертификаты безопасности».",
      body2: "Индустрии нужен был единый рейтинг, выходящий за рамки аудита кода и измеряющий реальную безопасность.",
      body3: "SafeScoring появился из этой потребности.",
      stats: {
        norms: "норм безопасности",
        pillars: "столпов SAFE",
        types: "типы продуктов",
        framework: "единый фреймворк",
      },
    },
    values: {
      title: "Наши ценности",
      subtitle: "Принципы, которые ведут каждый опубликованный балл",
      independence: {
        title: "Независимость",
        desc: "Партнерские отношения раскрываются и не влияют на оценки.",
      },
      transparency: {
        title: "Прозрачность",
        desc: "Открытая методология. Каждая норма и критерий публикуются.",
      },
      rigor: {
        title: "Строгость",
        desc: "{totalNorms} норм по 4 столпам. На основе нашей опубликованной методологии.",
      },
      accessibility: {
        title: "Доступность",
        desc: "Знания о безопасности для всех, а не только для технарей.",
      },
    },
    cta: {
      title: "Готовы увидеть разницу?",
      body: "Изучите наши рейтинги продуктов или узнайте больше о методологии.",
      primary: "Смотреть продукты",
      secondary: "Изучить методологию",
    },
  },
  audit: {
    hero: {
