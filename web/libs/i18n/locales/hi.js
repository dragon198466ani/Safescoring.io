...
export default {
  ...
  seo: {
    // Homepage
    homeTitle: "SafeScoring - क्रिप्टो सुरक्षा रेटिंग और वॉलेट तुलना",
    homeDescription: "सभी क्रिप्टो उत्पादों के लिए पहली एकीकृत सुरक्षा रेटिंग। हार्डवेयर वॉलेट, सॉफ्टवेयर वॉलेट, एक्सचेंज और DeFi प्रोटोकॉल की तुलना करें। 1100 मानदंड। 500+ उत्पाद मूल्यांकित।",
    
    // Products page
    productsTitle: "क्रिप्टो उत्पाद सुरक्षा डेटाबेस | SafeScoring",
    productsDescription: "500+ क्रिप्टो उत्पादों के सुरक्षा स्कोर देखें। प्रत्येक उत्पाद 1100 सुरक्षा मानदंडों के अनुसार मूल्यांकित। वॉलेट, एक्सचेंज, DeFi प्रोटोकॉल की तुलना करें।",
    
    // Compare page
    compareTitle: "क्रिप्टो उत्पादों की तुलना करें - सुरक्षा तुलना उपकरण | SafeScoring",
    compareDescription: "क्रिप्टो वॉलेट, एक्सचेंज और DeFi प्रोटोकॉल की सुरक्षा की साथ-साथ तुलना। सबसे सुरक्षित उत्पाद खोजें।",
    
    // Methodology page
    methodologyTitle: "SAFE पद्धति - हम क्रिप्टो सुरक्षा का मूल्यांकन कैसे करते हैं | SafeScoring",
    methodologyDescription: "जानें कि SafeScoring 4 स्तंभों में क्रिप्टो उत्पादों का मूल्यांकन कैसे करता है: सुरक्षा, प्रतिकूलता, निष्ठा, दक्षता। 1100 मानदंड। पारदर्शी पद्धति।",
    
    // Best pages
    bestHardwareWallets: "सर्वश्रेष्ठ हार्डवेयर वॉलेट {year} - सुरक्षा रैंकिंग | SafeScoring",
    bestSoftwareWallets: "सर्वश्रेष्ठ सॉफ्टवेयर वॉलेट {year} - सुरक्षा रैंकिंग | SafeScoring",
    bestExchanges: "सर्वश्रेष्ठ क्रिप्टो एक्सचेंज {year} - सुरक्षा रैंकिंग | SafeScoring",
    bestDefi: "सर्वश्रेष्ठ DeFi प्रोटोकॉल {year} - सुरक्षा रैंकिंग | SafeScoring",
  },
  ...
  // Hero
  hero: {
    tagline: "{totalNorms} मानदंड। {totalProducts}+ उत्पाद मूल्यांकित।",
    title: "आपके क्रिप्टो स्टैक में एक",
    titleHighlight: "सुरक्षा अंधा स्थान है",
    subtitle: "हार्डवेयर वॉलेट। सॉफ्टवेयर वॉलेट। DeFi प्रोटोकॉल।",
    subtitleStrong: "सभी एक ही कठोर पद्धति से मूल्यांकित।",
    ctaPrimary: "अपने स्टैक का विश्लेषण करें",
    ctaSecondary: "उत्पाद देखें",
    trustIndicator: "मुफ़्त · 2 मिनट · पंजीकरण की आवश्यकता नहीं",
    statsNorms: "मानदंड",
  ...
  productDetail: {
    ...
    typeSeparator: "•",
    typeUnknown: "अज्ञात",
    descriptionFallback: "{product} एक {type} है जिसे SafeScoring द्वारा मूल्यांकित किया गया है।",
  },

  about: {
    meta: {
      title: "{app} के बारे में - हमारा मिशन",
      description: "जानिए SafeScoring का मिशन: क्रिप्टो सुरक्षा रेटिंग में पारदर्शिता और निष्पक्षता लाना।",
    },
    hero: {
      badge: "हमारा मिशन",
      titleStart: "क्रिप्टो सुरक्षा को",
      titleHighlight: "मापने योग्य बनाना",
      subtitle: "सुरक्षा को वस्तुनिष्ठ, पारदर्शी और सभी के लिए सुलभ होना चाहिए। न मार्केटिंग, न प्रायोजन—सिर्फ डेटा।",
    },
    problem: {
      title: "जो समस्या हमने देखी",
      body1: "रिपोर्ट्स के अनुसार अधिकांश हैक हुए DeFi प्रोजेक्ट पहले ही ऑडिट किए गए थे। “सुरक्षा प्रमाणपत्र” होने पर भी अरबों का नुकसान हुआ।",
      body2: "उद्योग को कुछ अलग चाहिए था: एक एकीकृत रेटिंग जो कोड ऑडिट से आगे जाकर वास्तविक सुरक्षा को मापे।",
      body3: "SafeScoring इसी आवश्यकता से जन्मा।",
      stats: {
        norms: "सुरक्षा मानक",
        pillars: "SAFE स्तंभ",
        types: "उत्पाद प्रकार",
        framework: "एकीकृत फ्रेमवर्क",
      },
    },
    values: {
      title: "हमारे मूल्य",
      subtitle: "हर प्रकाशित स्कोर को मार्गदर्शित करने वाले सिद्धांत",
      independence: {
        title: "स्वतंत्रता",
        desc: "साझेदार स्कोर को प्रभावित नहीं करते। केवल कार्यप्रणाली मायने रखती है।",
      },
      transparency: {
        title: "पारदर्शिता",
        desc: "खुली कार्यप्रणाली। हर मानक और मापदंड सार्वजनिक है।",
      },
      rigor: {
        title: "कठोरता",
      ...
      accessibility: {
        title: "सुगम्यता",
        desc: "सुरक्षा ज्ञान सभी के लिए, सिर्फ तकनीकी विशेषज्ञों के लिए नहीं।",
      },
    },
    cta: {
      title: "अंतर देखने के लिए तैयार हैं?",
      body: "हमारे उत्पाद रेटिंग देखें या हमारी कार्यप्रणाली जानें।",
      primary: "उत्पाद देखें",
      secondary: "कार्यप्रणाली सीखें",
    },
  },
  audit: {
    hero: {
