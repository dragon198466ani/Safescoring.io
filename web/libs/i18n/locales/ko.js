...
export default {
  ...
  seo: {
    // Homepage
    homeTitle: "SafeScoring - 암호화폐 보안 평가 & 지갑 비교",
    homeDescription: "모든 암호화폐 제품에 대한 최초의 통합 보안 평가. 하드웨어 지갑, 소프트웨어 지갑, 거래소 및 DeFi 프로토콜을 비교하세요. 1100개 기준. 500개 이상 제품 평가.",
    
    // Products page
    productsTitle: "암호화폐 제품 보안 데이터베이스 | SafeScoring",
    productsDescription: "500개 이상의 암호화폐 제품 보안 점수를 확인하세요. 각 제품은 1100개의 보안 기준으로 평가됩니다. 지갑, 거래소, DeFi 프로토콜을 비교하세요.",
    
    // Compare page
    compareTitle: "암호화폐 제품 비교 - 보안 비교 도구 | SafeScoring",
    compareDescription: "암호화폐 지갑, 거래소 및 DeFi 프로토콜의 보안을 나란히 비교하세요. 가장 안전한 제품을 찾으세요.",
    
    // Methodology page
    methodologyTitle: "SAFE 방법론 - 암호화폐 보안 평가 방법 | SafeScoring",
    methodologyDescription: "SafeScoring이 4가지 기둥으로 암호화폐 제품을 평가하는 방법을 알아보세요: 보안, 역경, 충실도, 효율성. 1100개 기준. 투명한 방법론.",
    
    // Best pages
    bestHardwareWallets: "최고의 하드웨어 지갑 {year} - 보안 랭킹 | SafeScoring",
    bestSoftwareWallets: "최고의 소프트웨어 지갑 {year} - 보안 랭킹 | SafeScoring",
    bestExchanges: "최고의 암호화폐 거래소 {year} - 보안 랭킹 | SafeScoring",
    bestDefi: "최고의 DeFi 프로토콜 {year} - 보안 랭킹 | SafeScoring",
  },
  ...
  // Hero
  hero: {
    tagline: "{totalNorms}개 기준. {totalProducts}개 이상 제품 평가.",
    title: "당신의 암호화폐 스택에는",
  ...
  productDetail: {
    ...
    typeSeparator: "•",
    typeUnknown: "알 수 없음",
    descriptionFallback: "{product}는 SafeScoring에서 평가한 {type}입니다.",
  },

  about: {
    meta: {
      title: "{app} 소개 - 우리의 미션",
      description: "SafeScoring이 암호화폐 보안 평가에 투명성과 객관성을 더하는 미션을 확인하세요.",
    },
    hero: {
      badge: "우리의 미션",
      titleStart: "크립토 보안을",
      titleHighlight: "측정 가능하게",
      subtitle: "보안은 객관적이고 투명하며 모두에게 열려 있어야 합니다. 마케팅도, 스폰서도 아닌 오직 데이터.",
    },
    problem: {
      title: "우리가 본 문제",
      body1: "보고서에 따르면 해킹된 DeFi 프로젝트 대부분이 이미 감사를 받았습니다. “보안 인증”에도 불구하고 수십억이 사라졌습니다.",
      body2: "코드 감사 그 이상으로 실제 보안을 측정하는 통합 평가가 필요했습니다.",
      body3: "SafeScoring은 그 필요에서 탄생했습니다.",
      stats: {
        norms: "보안 규범",
        pillars: "SAFE 기둥",
        types: "제품 유형",
    ...
    values: {
      ...
      accessibility: {
        title: "접근성",
        desc: "기술 전문가뿐 아니라 모두를 위한 보안 지식.",
      },
    },
    cta: {
      title: "차이를 직접 보시겠습니까?",
      body: "제품 평가를 살펴보거나 방법론을 알아보세요.",
      primary: "제품 둘러보기",
      secondary: "방법론 알아보기",
    },
  },
