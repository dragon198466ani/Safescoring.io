...
export default {
  ...
  seo: {
    // Homepage
    homeTitle: "SafeScoring - 加密货币安全评级 & 钱包比较",
    homeDescription: "首个统一的加密货币产品安全评级。比较硬件钱包、软件钱包、交易所和DeFi协议。1100项标准。500+产品评估。",
    
    // Products page
    productsTitle: "加密货币产品安全数据库 | SafeScoring",
    productsDescription: "查看500+加密货币产品的安全评分。每个产品按1100项安全标准评估。比较钱包、交易所、DeFi协议。",
    
    // Compare page
    compareTitle: "比较加密货币产品 - 安全比较工具 | SafeScoring",
    compareDescription: "并排比较加密货币钱包、交易所和DeFi协议的安全性。找到最安全的产品。",
    
    // Methodology page
    methodologyTitle: "SAFE方法论 - 我们如何评估加密货币安全 | SafeScoring",
    methodologyDescription: "了解SafeScoring如何通过4个支柱评估加密货币产品：安全性、逆境、忠诚度、效率。1100项标准。透明的方法论。",
    
    // Best pages
    bestHardwareWallets: "最佳硬件钱包 {year} - 安全排名 | SafeScoring",
    bestSoftwareWallets: "最佳软件钱包 {year} - 安全排名 | SafeScoring",
    bestExchanges: "最佳加密货币交易所 {year} - 安全排名 | SafeScoring",
    bestDefi: "最佳DeFi协议 {year} - 安全排名 | SafeScoring",
  },
  ...
  // Hero
  hero: {
    tagline: "{totalNorms}项标准。{totalProducts}+产品评估。",
    title: "您的加密货币堆栈存在",
    titleHighlight: "安全盲点",
  ...
  productDetail: {
    ...
    typeSeparator: "•",
    typeUnknown: "æœªçŸ¥",
    descriptionFallback: "{product} æ˜¯ç”± SafeScoring è¯„ä¼°çš„ {type}ã€‚",
  },
  about: {
    meta: {
      title: "关于 {app} - 我们的使命",
      description: "了解 SafeScoring 的使命：为加密安全评级带来透明和客观。",
    },
    hero: {
      badge: "我们的使命",
      titleStart: "让加密安全",
      titleHighlight: "可衡量",
      subtitle: "安全应当客观、透明且人人可及。不是营销，也非赞助，只有数据。",
    },
    problem: {
      title: "我们看到的问题",
      body1: "报告显示，大多数被攻击的 DeFi 项目都经过审计。尽管有“安全认证”，仍损失数十亿美元。",
      body2: "行业需要不同的东西：超越代码审计、衡量真实安全性的统一评级。",
      body3: "SafeScoring 因此诞生。",
      stats: {
        norms: "安全规范",
        pillars: "SAFE 支柱",
        types: "产品类型",
    ...
    values: {
      ...
      accessibility: {
        title: "可及性",
        desc: "面向所有人的安全知识，而非仅限技术专家。",
      },
    },
    cta: {
      title: "准备好看到不同了吗？",
      body: "浏览我们的产品评分或进一步了解方法论。",
      primary: "浏览产品",
      secondary: "了解方法论",
    },
  },
