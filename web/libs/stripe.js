...
// Singleton Stripe instance - only create once
...
export const createCheckout = async ({
  ...
  // Add trial period for subscriptions (EU compliant - requires card upfront)
  if (mode === "subscription" && trialDays && trialDays > 0) {
    extraParams.subscription_data = {
      trial_period_days: trialDays,
    };
    // Require payment method collection for trial (EU regulation)
    extraParams.payment_method_collection = "always";
  }
