...
const Methodology = async () => {
  ...
  const pillarEducationalContent = {
    S: {
      title: t("methodologyPage.pillarS.title"),
      subtitle: t("methodologyPage.pillarS.subtitle"),
      introduction: t("methodologyPage.pillarS.introduction"),
      whyItMatters: t("methodologyPage.pillarS.whyItMatters"),
      essentialStandards: [
        {
          name: "NIST SP 800-57",
    ...
    A: {
      title: t("methodologyPage.pillarA.title"),
      subtitle: t("methodologyPage.pillarA.subtitle"),
      introduction: t("methodologyPage.pillarA.introduction"),
      whyItMatters: t("methodologyPage.pillarA.whyItMatters"),
      essentialStandards: [
        {
    ...
    F: {
      title: t("methodologyPage.pillarF.title"),
      subtitle: t("methodologyPage.pillarF.subtitle"),
      introduction: t("methodologyPage.pillarF.introduction"),
      whyItMatters: t("methodologyPage.pillarF.whyItMatters"),
      essentialStandards: [
        {
          name: "SOC 2 Type II",
    ...
    E: {
      title: t("methodologyPage.pillarE.title"),
      subtitle: t("methodologyPage.pillarE.subtitle"),
      introduction: t("methodologyPage.pillarE.introduction"),
      whyItMatters: t("methodologyPage.pillarE.whyItMatters"),
      essentialStandards: [
        {
          name: "WCAG 2.1",
  ...
  return (
    <main className="min-h-screen bg-base-100">
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            {t("methodologyPage.title", { highlight: "" }).split("").length ? (
              <>
                {t("methodologyPage.title", { highlight: "__SPLIT__" }).split("__SPLIT__")[0]}
                <span className="text-gradient-safe">{t("methodologyPage.titleHighlight")}</span>
                {t("methodologyPage.title", { highlight: "__SPLIT__" }).split("__SPLIT__")[1]}
              </>
            ) : null}
          </h1>
          <p className="text-lg text-base-content/60 max-w-2xl mx-auto mb-8">
            {t("methodologyPage.subtitle", { norms: normStats?.totalNorms ?? "—" })}
          </p>
          <div className="flex justify-center gap-8 text-center">
            <div>
              <div className="text-3xl font-bold text-primary">{normStats?.totalNorms ?? "—"}</div>
              <div className="text-sm text-base-content/60">{t("methodologyPage.securityNorms")}</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-primary">4</div>
              <div className="text-sm text-base-content/60">{t("methodologyPage.corePillars")}</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-primary">{normStats?.totalProducts ?? "—"}+</div>
              <div className="text-sm text-base-content/60">{t("methodologyPage.productsEvaluated")}</div>
            </div>
          </div>
        </div>
      </section>
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  >
                    <h3 className="font-semibold text-lg mb-3 flex items-center gap-2">
                      ...
                      {t("methodologyPage.whyItMatters")}
                    </h3>
                  ...
                  <div className="p-6 rounded-2xl bg-base-200/50 border border-base-300">
                    <h3 className="font-semibold text-lg mb-3 flex items-center gap-2">
                      ...
                      {t("methodologyPage.whatWeEvaluate")}
                    </h3>
                ...
                <div className="mt-8">
                  <h3 className="font-semibold text-lg mb-4 flex items-center gap-2">
                    ...
                    {t("methodologyPage.essentialStandards")}
                  </h3>
      ...
      <section className="py-16 px-6 bg-base-200/50 border-t border-base-300">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-bold mb-4">{t("methodologyPage.ctaTitle")}</h2>
          <p className="text-base-content/60 mb-8">
            {t("methodologyPage.ctaSubtitle", { norms: normStats?.totalNorms ?? "—" })}
          </p>
          <Link href="/products" className="btn btn-primary btn-lg">
            {t("methodologyPage.viewAllProducts")}
          </Link>
        </div>
      </section>
    </main>
