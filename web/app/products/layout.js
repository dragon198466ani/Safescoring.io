...
export const metadata = {
  ...
  description: `Browse security scores for 100+ crypto products. Each product is evaluated against ${config.safe?.stats?.totalNorms || 2376} security norms across Security, Adversity, Fidelity & Efficiency pillars. Compare wallets, exchanges, DeFi protocols and more.`,
  keywords: [
    "crypto security",
