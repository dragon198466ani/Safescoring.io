...
FREE_FEATURES = {
    ...
    'methodology': {
        ...
        'description': '2159 security norms, transparent evaluation',
        'marketing_phrases': [
            '2159 security norms',
...
They analyze wallets against 2159 security criteria. All scores are public.
...
They check 2159 things apparently. Some wallets fail basic checks.
