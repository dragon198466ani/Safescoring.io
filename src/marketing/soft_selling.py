...
CURIOSITY_HOOKS = {
    ...
    'authority': [
        "We evaluate 2376 security norms. Most products fail half.",
...
But you can check all of them here → safescoring.io/products""",
    ...
    """We analyze 2376 security criteria for every crypto product.
...
They rate wallets against 2376 security criteria. All scores are public.
...
The methodology is transparent (2376 norms they check for)."""
    },
    {
...
At SafeScoring, we evaluate 2376 criteria across 4 dimensions:
