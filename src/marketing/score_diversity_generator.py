...
safescoring.io/products/{top['slug']}"""
    ...
    def generate_reddit_post(self, product_type: str = None) -> dict:
        ...
        return {
            ...
            'body': f"""I run SafeScoring.io where we evaluate crypto products against 2159 security norms.
...
At SafeScoring, we rate every product against 2159 security norms. Same standards for everyone. No pay-to-play.
